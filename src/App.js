      ...
      <BrowserRouter>
        <div>
          <Routes>
            ...
            <Route path="/activity" element={<Page properties={atividade} passColorNavbar={passColorNavbar} />} />
            <Route path="/local" element={<PageReverse properties={local} passColorNavbar={passColorNavbar} />} />
